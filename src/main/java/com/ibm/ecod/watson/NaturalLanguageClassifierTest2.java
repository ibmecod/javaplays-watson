 ...
 * 
 */
public class NaturalLanguageClassifierTest2
{
	public static void main(String[] args)
	{
		...
		classifierId = "f1704ex55-nlc-888";
		System.out.println("Classifier created with id " + classifierId);

		//System.out.println("Waiting for classifier to be trained  ...");
		...
		if (!interrupted)
		{
			...
			System.out.println("Querying classifier with \"Will it be windy today?\"");
			Classification classification2 = service.classify(classifierId, "Will it be windy today?");
			System.out.println("Results:");
