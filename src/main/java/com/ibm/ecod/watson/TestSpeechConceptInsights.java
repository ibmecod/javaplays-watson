...
//	    service.recognizeUsingWebSockets(new FileInputStream(new File("input/videoplayback.wav")), options, new BaseRecognizeDelegate() {
...
//	    });
	    ...
	    SpeechResults speechResults = service.recognize(new File("input/writing_groovy_ATS.ogg"), options);
